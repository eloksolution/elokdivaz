...
public class PackagesView extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        pName=(TextView) findViewById(R.id.group_view_title);
        pDescription=(TextView) findViewById(R.id.description);
        pRate=(TextView) findViewById(R.id.offer_rate);
        ...
        book.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent=new Intent(PackagesView.this, Consult.class);
                intent.putExtra("serviceName",pName.getText().toString());
                intent.putExtra("servicprice",pRate.getText().toString());
        ...
        rating.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                serviceDialogRating(PackagesView.this, imagePath);
        ...
        PackageViewHelper getGroupsValue=new PackageViewHelper(this);
        ...
        packImage=(ImageView) findViewById(R.id.group_image_view);
    ...
    public  void serviceDialogRating(final PackagesView context, String id) {
    ...
    public void setValuesToTextFields(String result) {
        ...
        if (result != null) {
            ...
            if(fromJsonn.getImgePath()!=null) {
                ...
                glide.with(PackagesView.this).load(R.drawable.sallon_two).diskCacheStrategy(DiskCacheStrategy.ALL).into(packImage);
            }
        }
