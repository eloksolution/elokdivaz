...
public class LoginActivity extends AppCompatActivity implements
    ...
    private void handleSignInResult(GoogleSignInResult result) {
        ...
        if (result.isSuccess()) {
            ...
            CompanyDTO registerDto=updateRegistrationOnServer(acct);
    ...
    private CompanyDTO updateRegistrationOnServer(GoogleSignInAccount acct) {
            if (CheckInternet.checkInternetConenction(LoginActivity.this)) {

                String gurl = Config.SERVER_URL+"user/add";
                try {
                    CompanyDTO registerDto= buildDTOObject(acct);
    ...
    private CompanyDTO buildDTOObject(GoogleSignInAccount acct) {
        ...
        if(photoURI!=null){
            registerDto.setImgPath1(photoURI.toString());
        }
        ...
        registerDto.setLongitude(""+longi);
        registerDto.setLatitude(""+latti);
    ...
    public void updateUI(boolean signedIn, CompanyDTO registerDto) {
