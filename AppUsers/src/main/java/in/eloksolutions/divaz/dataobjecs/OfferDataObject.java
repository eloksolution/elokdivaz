...
public class OfferDataObject {
    ...
    public OfferDataObject(String id, String name, String description, String offerPrice, String beforeOfferPrice, String imgePath, String startDate, String endDate, String createdDate) {
        this.id = id;
        this.name = name;
