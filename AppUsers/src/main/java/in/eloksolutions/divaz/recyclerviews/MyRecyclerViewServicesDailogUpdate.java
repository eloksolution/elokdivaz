...
public class MyRecyclerViewServicesDailogUpdate extends RecyclerView
        .Adapter<MyRecyclerViewServicesDailogUpdate
        .DataObjectHolder> {
    ...
    public MyRecyclerViewServicesDailogUpdate(ArrayList<ServiceOBJ> myDataset, ApointMentUpdate mcontext, TextView serviName, TextView servicePric) {
        mDataset = myDataset;
