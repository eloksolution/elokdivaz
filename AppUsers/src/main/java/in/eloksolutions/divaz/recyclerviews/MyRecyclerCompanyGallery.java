...
public class MyRecyclerCompanyGallery extends RecyclerView
        .Adapter<MyRecyclerCompanyGallery
        .DataObjectHolder> {
    ...
    public MyRecyclerCompanyGallery(ArrayList<GalleryOBJ> myDataset, Context context) {
        mDataset = myDataset;
        this.context = context;
    }

    public MyRecyclerCompanyGallery(Context context, List<CompanyOBJ> itemList) {
