...
import in.eloksolutions.divaz.activities.ServiceSOrRates;
...
public class GetCompanyHelper extends AsyncTask<String, Void, String > {
    String urls;
    ProgressDialog progress;
    ServiceSOrRates serviceSOrRates;
    ServiceDataObject serviceDataObject;
    String companyId;
    public GetCompanyHelper(String urls, ServiceSOrRates serviceSOrRates, ServiceDataObject serviceDataObject) {
        this.urls = urls;
