...
public class OfferOBJ {
    ...
    public OfferOBJ(String id, String name, String description, String beforeOfferPrice, String offerPrice, String imgePath, String startDate, String endDate, String createdDate) {
        this.id = id;
        this.name = name;
