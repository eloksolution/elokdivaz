...
import in.eloksolutions.divaz.recyclers.MyRecyclerViewServicesDailog;
...
public class GetServicesDailogHelpers extends AsyncTask<String, Void, String> {
    ...
    public GetServicesDailogHelpers(Packages mcontext, String surl, RecyclerView rvGroups, TextView noData) {
    ...
    protected void onPostExecute(String result) {
        ...
        if (result!=null && result.trim().length()>0) {
            ...
            if (!results.isEmpty()) {
                ...
                MyRecyclerViewServicesDailog mAdapter = new MyRecyclerViewServicesDailog(results, mcontext);
