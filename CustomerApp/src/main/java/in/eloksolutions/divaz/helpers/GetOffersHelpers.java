...
import in.eloksolutions.divaz.recyclers.MyRecyclerViewOffers;
...
public class GetOffersHelpers extends AsyncTask<String, Void, String> {
    ...
    public GetOffersHelpers(Context mcontext, String surl, RecyclerView rvGroups, TextView noData) {
    ...
    protected void onPostExecute(String result) {
        ...
        if (result!=null && result.trim().length()>0) {
            ...
            if (!results.isEmpty()) {
                ...
                noData.setText("Create Offer Here");
