    ...
    public void setValuesToTextFields(String result) {
        ...
        if (result != null) {
            ...
            if(fromJsonn.getImgPath()!=null) {
                glide.with(MessageUpdate.this).load(Config.IMG_AWS +fromJsonn.getImgPath()).diskCacheStrategy(DiskCacheStrategy.ALL).into(messageImg);
            }else{
                glide.with(MessageUpdate.this).load(R.drawable.sallon_two).diskCacheStrategy(DiskCacheStrategy.ALL).into(messageImg);
            }
        }
