...
public class PackagesUpdate extends AppCompatActivity {
    ...
    public void setValuesToTextFields(String result) {
        ...
        if (result != null) {
            ...
            if(fromJsonn.getImgePath()!=null) {
                glide.with(PackagesUpdate.this).load(Config.IMG_AWS +fromJsonn.getImgePath()).diskCacheStrategy(DiskCacheStrategy.ALL).into(imgView);
            }else{
                glide.with(PackagesUpdate.this).load(R.drawable.sallon_two).diskCacheStrategy(DiskCacheStrategy.ALL).into(imgView);
            }
        }
    ...
    private String savePackageDetails() {
        ...
        keyName="siri/packages/M__"+ Util.getRandomNumbers()+"_"+System.currentTimeMillis();
    ...
    private PackagesDTO buildDTOObject() {
        ...
        packagesDTO.setImagePath(keyName);
        return packagesDTO;
    }
