    ...
    public void setValuesToTextFields(String result) {
        ...
        if (result != null) {
            ...
            if(fromJsonn.getImgePath()!=null) {
                glide.with(OfferUpdate.this).load(Config.IMG_AWS +fromJsonn.getImgePath()).diskCacheStrategy(DiskCacheStrategy.ALL).into(createOffer);
            }else{
                glide.with(OfferUpdate.this).load(R.drawable.sallon_two).diskCacheStrategy(DiskCacheStrategy.ALL).into(createOffer);
            }
        }
