...
import in.eloksolutions.divaz.helpers.MessageViewHelper;
...
String messageId;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        messageImg=(ImageView) findViewById(R.id.msg_img);
        ...
        setTransferUtility();
        MessageViewHelper getGroupsValue=new MessageViewHelper(this);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                messageImg.setScaleType(ImageView.ScaleType.FIT_XY);
                messageImg.setImageURI(resultUri);
    ...
    public void setValuesToTextFields(String result) {
        ...
        if (result != null) {
            ...
            if(fromJsonn.getImgPath()!=null) {
                glide.with(MessageView.this).load(Config.IMG_AWS +fromJsonn.getImgPath()).diskCacheStrategy(DiskCacheStrategy.ALL).into(messageImg);
            }else{
                glide.with(MessageView.this).load(R.drawable.sallon_two).diskCacheStrategy(DiskCacheStrategy.ALL).into(messageImg);
            }
        }
    ...
    private String saveSErviceDetails() {
        keyName="siri/messages/M_"+ Util.getRandomNumbers()+"_"+System.currentTimeMillis();
        ...
        /*if (checkValidation()) {
            if (CheckInternet.checkInternetConenction(MessageView.this)) {
                ...
                CheckInternet.showAlertDialog(MessageView.this, "No Internet Connection",
    ...
    private String buildJson(MessageDTO messageDTO) {
        try {
            ...
            jsonObject.accumulate("img_path", keyName);
