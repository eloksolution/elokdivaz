...
import in.eloksolutions.beaty.dataobjecs.CompanyOBJ;
...
public class MyRecyclerViewCompany extends RecyclerView
    ...
    public class DataObjectHolder extends RecyclerView.ViewHolder
        ...
        public DataObjectHolder(final View itemView) {
            ...
            edit.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent=new Intent(Intent.ACTION_CALL, Uri.parse("tel:" + "+919492888989"));
    ...
    public void onBindViewHolder(DataObjectHolder holder, int position) {
        ...
        if (mDataset.get(position).getDescriptioin()!=null) {
            holder.itemDescription.setText(mDataset.get(position).getDescriptioin());
        }
