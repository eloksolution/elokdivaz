...
public class CompanyView extends AppCompatActivity implements View.OnClickListener{
...
String messageId;
    ...
    public void setValuesToTextFields(String result) {
        ...
        if (result != null) {
            ...
            messageName.setText(fromJsonn.getName());
            messageDescription.setText(fromJsonn.getDescriptioin());
            if(fromJsonn.getImgPath1()!=null) {
                glide.with(CompanyView.this).load(Config.IMG_AWS +fromJsonn.getImgPath1()).diskCacheStrategy(DiskCacheStrategy.ALL).into(messageImg);
            }else{
                glide.with(CompanyView.this).load(R.drawable.sallon_two).diskCacheStrategy(DiskCacheStrategy.ALL).into(messageImg);
            }
        }
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        switch (item.getItemId()) {
            ...
            case R.id.home_button:
                startActivity(new Intent(this, CompanyView.class));
                return true;
