...
import in.eloksolutions.beaty.activities.PackagesUpdate;
...
public class PackageUpdateHelper {

    private PackagesUpdate mcontext;

    public PackageUpdateHelper(PackagesUpdate mcontext) {
