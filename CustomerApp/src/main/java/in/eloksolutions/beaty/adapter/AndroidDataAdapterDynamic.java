...
import in.eloksolutions.beaty.activities.dtoclasses.PackageItem;
import in.eloksolutions.beaty.util.Config;


public class AndroidDataAdapterDynamic extends RecyclerView.Adapter<AndroidDataAdapterDynamic.ViewHolder> {
    ...
    public AndroidDataAdapterDynamic(Context context) {
